...
# Ukrainian Localization / Український переклад

Це українська локалізація Cannoli — фронтенду для ретро-ігор на Android, заснованого на оригінальному проєкті CannoliHQ/cannoli. Переклад охоплює весь інтерфейс: налаштування, меню, діалоги, онбординг та внутрішньоігрове меню.
